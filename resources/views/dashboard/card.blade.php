<div class="card card-post shadow-sm">
    <div class="position-relative">
        <img id="imagem-post" src={{ $book->cover }} class="w-100"
            alt="{{ $book->title }}">
    ...
    <div class="p-3">
        ...
        <small class="text-muted">{{ $book->author }} - {{ $book->category->name }}<br>Publicado em: {{ $book->created_at }}</small>
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="text-warning">
                @for ($i = 1; $i <= 5; $i++)
                    <i class="bi {{ $i <= $book->stars ? 'bi-star-fill' : 'bi-star' }}"></i>
                @endfor
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" id="novaImagemUrl" class="form-control"
